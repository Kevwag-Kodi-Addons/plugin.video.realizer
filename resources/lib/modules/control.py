...
def yesnoDialog(line1, line2, line3, heading=addonInfo('name'), nolabel='', yeslabel=''):
    return dialog.yesno(heading, six.ensure_str( line1 ) + six.ensure_str( line2 ) + six.ensure_str( line3 ), nolabel, yeslabel)
...
def moderator():
    netloc = [urlparse(sys.argv[0]).netloc, '', 'plugin.video.realizer']
